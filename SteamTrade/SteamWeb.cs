...
namespace SteamTrade
{
    ...
    {
        public static string RetryWebRequest(string url, string method, NameValueCollection data = null, CookieContainer cookies = null, bool ajax = true, string referer = "")
        {
            for (int i = 0; i < 9001; i++)
            {
                ...
                catch (WebException ex)
                {
                    ...
                    Console.WriteLine("Request #" + i + " failed: " + url + ". " + ex.Message);
        ...
        public static string Fetch (string url, string method, NameValueCollection data = null, CookieContainer cookies = null, bool ajax = true, string referer = "")
        {            
            try
            {
                HttpWebResponse response = Request(url, method, data, cookies, ajax, referer);
